                    ...
                    <ul>
                        ...
                        {notifications.length ? notifications.map((notification) => (
                            <li key={notification._id}
                                className={`p-2 border-b border-white text-white ${notification.status === 'unread' ? 'notification-unread hover:bg-rimary transition-colors duration-300' : 'notification-read hover:bg-grey-300 transition-colors duration-300'}`}
