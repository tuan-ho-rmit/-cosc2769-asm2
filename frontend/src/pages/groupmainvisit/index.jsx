...
import ListOfPostsVisit from '../post/components/ListOfPostsVisit';

const GroupMainVisit = () => {
        ...
        for (let i = 0; i < files.length; i++) {
            ...
            reader.onload = (e) => {
                ...
                if (images.length === files.length) {
                    // update after all datas are loaded
                    setImages(images);
                }
            };
